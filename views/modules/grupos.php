         ...
         <table id="example" class="table table-striped table-bordered display dataTable" style="width: 100%;" role="grid" aria-describedby="example_info"> 
						<thead>
							<tr >
								...
								<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 298px;" aria-label="Position: activate to sort column ascending">Clave</th>
								...
								<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 71px;" aria-label="Age: activate to sort column ascending">Cuatrimestre</th>
								...
								<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 136px;" aria-label="Start date: activate to sort column ascending">Materias</th>
						</thead> 	
					<tbody>
						<?php
						$vistaMaestro = new MvcController();
						$vistaMaestro -> vistaGruposController();
						$vistaMaestro -> borrarGrupoController();
						?>
					</tbody>
							...
							<tr>
								...
								<th rowspan="1" colspan="1">Cuatrimestre</th> 
								<th rowspan="1" colspan="1">Editar</th>
								<th rowspan="1" colspan="1">Borrar</th> 
								<th rowspan="1" colspan="1">Materias</th>
							</tr>
						</tfoot>
					</table>
        		</div>
